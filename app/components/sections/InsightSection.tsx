      ...
      <Container>
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {points.map((point, index) => (
            <Reveal key={point.title} delay={100 * (index + 1)}>
              <article className="interactive-card rounded-3xl border border-[color:var(--stroke)] bg-[color:var(--cream-100)] p-6 transition-transform duration-300 hover:-translate-y-1">
